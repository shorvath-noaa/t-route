...
def main_v04(argv):
    ...
    network, all_parameters = mu.initialize_network(argv)
    ...
    #TODO: this doesn't seem right, will overwrite network object
    network = mu.build_forcings(run_sets[0],
                                forcing_parameters,
                                hybrid_parameters,
                                compute_parameters)
    
    data_assimilation = mu.build_data_assimilation(network,
                                                   data_assimilation_parameters,
                                                   waterbody_parameters,
                                                   da_sets[0],
                                                   forcing_parameters,
